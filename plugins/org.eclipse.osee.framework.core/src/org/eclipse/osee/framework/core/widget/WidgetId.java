...
public class WidgetId extends OseeEnum {
   ...
   public static final WidgetId XArtifactTypeMultiChoiceWidget = new WidgetId("XArtifactTypeMultiChoiceWidget");
   public static final WidgetId XAttributeTypeComboViewerWidget = new WidgetId("XAttributeTypeComboViewerWidget");
   public static final WidgetId XAttributeTypeMultiChoiceSelectWidget = new WidgetId("XAttributeTypeMultiChoiceSelectWidget");
   ...
   public static final WidgetId XTextWithFileSelDialogWidget = new WidgetId("XFileTextWithSelectionDialogWidget");
   ...
   public static final WidgetId XListRelationWidget = new WidgetId("XListRelationWidget");
   ...
   public static final WidgetId XSelectFromMultiChoiceBranchWidget = new WidgetId("XSelectFromMultiChoiceBranchWidget");
   public static final WidgetId XStackedArtWidget = new WidgetId("XStackedArtWidget");
   public static final WidgetId XTextArtWidget = new WidgetId("XTextArtWidget");
   ...
   public WidgetId(String name) {
      this(++count, name);
      System.err.println("WidgetId: " + name);
